...
const Home = () => {
  ...
  return (
    ...
    <div className="bg-white min-w-7xl pl-30 pr-30">
      <h3 className="mt-26 mb-10 text-4xl font-bold text-black">{t('SOLARENGY_PLATFORM_DESC1')}</h3>
     ...
     text-center">{t('KEY_FEATURES')}</h3>
      ...
      <h3 className="mt-36 text-4xl font-bold text-black text-center">{t('INDUSTRY_APPLICATIONS')}</h3>
