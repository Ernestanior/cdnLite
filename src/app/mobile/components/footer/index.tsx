...
const Footer = () => {
  ...
  return (
    <footer>
      <div className="py-12 px-10 bg-amber-500 font-semibold">
        {/* 联系方式 */}
        <div className="text-white w-60">
          <h2 className=" mb-4">{t('CONTACT_US')}</h2>
          <p className="gap-2 text-sm text-white flex items-center">
            <span className="text-base text-white" >
              <PhoneOutlined />
            </span>
            <span>(65) 6284 6860</span>
          </p>
          <p className="mt-2 gap-2 text-sm text-white flex items-center">
            <span className="text-base  text-white">
              <MailOutlined />
            </span>
        ...
        {/* 底部导航 */}
        <div className="mt-5 text-white justify-around">
          <div>
          ...
          <div>
            <h3 className="font-semibold mb-3 mt-8">{t('SOLUTIONS')}</h3>
