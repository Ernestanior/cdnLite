        ...
        <div className="mb-10 flex shadow-lg ">
          ...
          <div className="p-10 w-100 bg-sky-950 rounded-tl-xl rounded-bl-xl ">
            <div className="h-110 bg-amber-500 rounded-lg flex items-center flex-col p-5 py-15">
              <div className=" font-bold text-2xl mb-20 rounded-4xl bg-sky-950 px-10 py-2 shadow-xl">{t("CONTACT_DETAIL")}</div>
              <div>
                <div className="mb-5 flex font-bold text-lg items-center"><PhoneFilled className="mr-3 text-lg bg-sky-950 p-2 rounded-2xl" /> +65 6284 6860</div>
                <div className="mb-5 flex font-bold text-lg  items-center"><MailFilled className="mr-3 text-lg bg-sky-950 p-2 rounded-2xl" /> sales@riftvalley.ai</div>
